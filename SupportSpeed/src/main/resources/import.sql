...
INSERT INTO `usuarios` (username, password, enabled,fk_persona) VALUES ('soporte3','$2a$10$xnGs.DiHewUsbrGC15UJi.96HjIKVo/UuP2GMmEHFSDqgAuUbXieu',1,5);
INSERT INTO `usuarios` (username, password, enabled,fk_persona) VALUES ('soporte4','$2a$10$9kE7cDjzm7ouAyiQv956zu2w4PYquOnMCn4vmaNWBye8g5izNxjom',1,6);
INSERT INTO `usuarios` (username, password, enabled,fk_persona) VALUES ('cliente2','$2a$10$FYmX5qY6EPHz/ABAkUkgzeaBogpF87Of7nPpEpaRUR8afWg.L9zge',1,7);
INSERT INTO `usuarios` (username, password, enabled,fk_persona) VALUES ('cliente3','$2a$10$mEy5YwGg6/iWWALHJN4HOudPRN3lI/zhEHMYP.F1VKB54jd3pXMP.',1,8);
